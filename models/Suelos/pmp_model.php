...
$no_caja,$control) {
    ...
    $stmt = $conn->prepare(
        "INSERT INTO pmp (peso_caja, peso_caja_mhumeda, peso_caja_mseca, psh, pss, porcentaje_pmp, 
        no_caja, control)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
    );

    $stmt->bind_param("dddddddd", $peso_caja, $peso_caja_mhumeda, $peso_caja_mseca, $psh, $pss, 
    $porcentaje_pmp, $no_caja, $control);
